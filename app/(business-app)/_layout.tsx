...
// floating). Four tabs for the solo (S1) pass: Today (what's happening right
// now), Calendar (month view + "+" to add a walk-in or scheduled
// appointment), Business (manage services/hours/policies — its own tab, not
// buried under Menu), and Menu (account identity + "Switch to browsing" +
// log out). Appointment Detail and the Services drill-down live outside this
// group (top-level `app/appointment/[bookingId].tsx` and `app/manage-
